...
show_list_items(letter_list)
show_list_items(cap_list)        
show_list_items(misc_list)
...
def population(state_data):
    ...
    print("The total population of this list of states is",sum_,
          "\nThere are",num_states,"states in this list of states.")
...
def diner_waitress():
    ...
    your_order = []
    while True:
        name = input("menu item: ")
        if name == "that's all":
            break
        your_order.append(name)
    print("\nyou've ordered: \n", your_order)
