...
#%%
def problem1_7():
    bases1 = float(input("Enter the length of one of the bases: "))
    bases2 = float(input("Enter the length of the other base: "))
    height = float(input("Enter the height: "))
    Area = .5 * (bases1 + bases2) * height
    print("The area of a trapezoid with bases",bases1, "and", bases2, 
