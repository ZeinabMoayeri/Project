...
"""
Problem 2_1:
Write a function 'problem2_1()' that sets a variable lis = list(range(20,30)) 
and does all of the following, each on a separate line: 
...
def problem2_2(my_list):
    ...
    print(new_my_list, end=(" "))
       
    new_my_list2 = []
    for i in range(0, 3): 
        new_my_list2.append(my_list[i])
    print()
    print(new_my_list2, end=(" "))
    
    new_my_list3 = []
    len_my_list = len(my_list)
    for i in range(3, len_my_list): 
        new_my_list3.append(my_list[i])
    print()
    print(new_my_list3, end=(" "))
...
def problem2_3(ne):
    for i in ne:
        letters_of_i = len(i)
        print(i, "has", letters_of_i, "letters.")
...
def problem2_7():
    ...
    area = ((s-side1)*(s-side2)*(s-side3)*s)**0.5
