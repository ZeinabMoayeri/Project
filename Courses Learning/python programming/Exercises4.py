...
print(alphlist)
#%%
Alphlist = ['e', 'F', 'h', 'A', 'D', 'F', 'b', 'D', 'b', 'J', 'a']
#%%
...
Alphlist.sort(key=str.lower)
print(Alphlist)
Alphlist.sort(key=str.capitalize)
print(Alphlist)
#%%
...
print(statistics.mean(nlisteven))
#%%
statistics.mean(rlist)
print(statistics.mean(rlist))
print(statistics.mean(rlisteven))
#%%
print(nlist)
...
print(statistics.median(rlisteven))   # print sorted version of rlisteven to see median
#%%
...
#   Python, neither generate an error.
    ...
    print("Mean: {0:>10}".format(statistics.mean(temps)))   
    print("Median: {0:>10}".format(statistics.median(temps)))

    print("Mean: {0:>10}".format(statistics.mean(temps)))
    try:
        print("Mode: {0:>10}".format(statistics.mode(temps)))
    except statistics.StatisticsError as e:
        print("Mode error: ", e)
    print("Standard Deviation: {0:>10} ".format(statistics.stdev(temps)))
    print("Variance: {0:>10}".format(statistics.variance(temps)))
...
print("Start||{0:25}||End".format(s),"- minimum width 25")
print("Start||{0:<25}||End".format(s),"- width 25, left aligned")
print("Start||{0:>25}||End".format(s),"- width 25, right aligned")
print("Start||{0:^25}||End".format(s),"- width 25, centered")
